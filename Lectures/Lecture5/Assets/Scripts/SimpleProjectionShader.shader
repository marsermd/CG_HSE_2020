    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed4 cx = i.normal.x * i.normal.x * tex2D(_XAlbedo, i.wPos.yz * _Scale);
                fixed4 cy = i.normal.y * i.normal.y * tex2D(_YAlbedo, i.wPos.xz * _Scale);
                fixed4 cz = i.normal.z * i.normal.z * tex2D(_ZAlbedo, i.wPos.xy * _Scale);
                fixed4 albedo = cx + cy + cz;
